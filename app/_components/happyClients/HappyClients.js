  ...
  return (
    <>
      <div>
        ...
        <div>
          {/* <div className="flex justify-between flex-col	lg:flex-row  mt-[60px] gap-y-[30px]"> */}
          <div className="slider-container relative mt-[50px]">
            ...
            <div
              className="bg-[#ffffff] h-[43px] w-[43px] rounded-[50%] absolute top-9 sm:top-[39%] right-0 sm:right-[-21px] lg:right-[6px]"
              onClick={nextSlide}
            >
              <Image
                src={svgs.rightArrow}
            ...
            <div
              className="bg-[#ffffff] h-[43px] w-[43px] rounded-[50%] absolute top-9 sm:top-[39%] sm:left-[-26px] lg:left-[-26px]	"
              onClick={prevSlide}
            >
              <Image
                src={svgs.LeftArrow}
